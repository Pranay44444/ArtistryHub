...
function UploadPage(){
  ...
  const [artworkDetails,setArtworkDetails] = useState({title: '',description: '',category: '',style: '',price: 299 })
  ...
  const availableCategories = ['Digital Art','Photography','Painting','Illustration','Sculpture','3D Art','Concept Art','Pixel Art','Other']
  const availableStyles = ['Abstract','Realistic','Impressionist','Expressionist','Surrealist','Minimalist','Pop Art','Fantasy','Other']
    ...
    <div className="upload-main">
      ...
      <div className="upload-grid">
        <div className="upload-left">
          ...
          <div 
            className={`upload-box ${isDropActive ? 'active' : ''}`}
          ...
          >
            {!imagePreview ? (
              <div className="upload-content">
                ...
                <p className="upload-title">Drag and drop your artwork</p>
                <p className="upload-subtitle">PNG, JPG, GIF files up to 5MB</p>
                <button className="upload-btn">
                  Browse Files
                </button>
              </div>
            ) : (
              <img src={imagePreview} alt="Artwork preview" className="upload-preview" />
            )}
          </div>
          <input
            ref={fileInputRef}
          ...
          <div className="upload-status">
            ...
            {selectedFile && (
              <button onClick={clearSelectedFile} className="upload-clear">
                Clear
              </button>
            )}
          </div>
        ...
        <div className="upload-right">
          ...
          <form onSubmit={submitArtwork}>
            ...
            <div className="upload-row">
              <div className="upload-field half">

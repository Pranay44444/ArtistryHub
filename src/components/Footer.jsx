      ...
      <div className="container">
        <div className="footer-grid">
          <div className="section">
            ...
            <div className="links">
              <a href="https://instagram.com" className="link" aria-label="Instagram">
                <Instagram />
              </a>
              <a href="https://twitter.com" className="link" aria-label="Twitter">
                <Twitter />
              </a>
              <a href="https://facebook.com" className="link" aria-label="Facebook">
                <Facebook />
              </a>
              <a href="mailto:chitarepranay85@gmail.com" className="link" aria-label="Email">
                <Mail/>
              </a>
            </div>
          </div>

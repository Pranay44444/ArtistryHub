...
function Header() {
  ...
  return (
    <header className={`header ${scrolled || showSearch || !isHomePage ? 'header-scrolled' : ''} ${!isHomePage ? 'non-home-header' : ''}`}>
        ...
        {isMenuOpen && (
          <nav className="mobile-nav">
            ...
            {isSignedIn ? (
              ...
              <Link to="/login" className="mobile-sign-in" onClick={() => setIsMenuOpen(false)}>
                Sign In
              </Link>
            )}
          </nav>
